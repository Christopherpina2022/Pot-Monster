...
namespace FGC_Stat_Analyzer_wpf.Services
{
    ...
    public class StartGgClient
    {
        ...
        /*
        public async Task<GraphQLResult> PagedAsync (string query, Dictionary<string, object?> variables)
        {
            try
            {
                int page = 1;
        ...
        */
        ...
        public async Task<GraphQLResult> ExecuteAsync(string query, string variableName, string variableValue) {
            try 
            {
